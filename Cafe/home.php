...
<div class="col-lg-9 mt-3">
    ...
    <div class="card mt-4 border-0 bg-light">
        <div class="card-body text-center">
            ...
            <p class="card-text">Nikmati suasana hangat kami dengan dekorasi minimalis yang menawan. 
                Pesan makanan dan minuman favorit Anda dengan mudah melalui aplikasi pesan online kami yang praktis. 
                Dari kopi segar hingga makanan ringan, semua dapat dinikmati dengan cepat dan efisien. 
                Temukan pengalaman unik di Cafe KPK dengan kenyamanan pesan online kami!
            </p>
        </div>
    </div>
    <!--Akhir Judul-->
